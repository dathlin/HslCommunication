	...
	public partial class FormDigitronCPL : HslFormContent
	{
		...
		private void button1_Click( object sender, EventArgs e )
		{
			...
			try
			{
				...
				userControlReadWriteOp1.SetReadWriteNet( yamateke, "100", false );
			}
			catch (Exception ex)
			{
		...
		{
			DemoUtils.BulkReadRenderResult( yamateke, textBox6, textBox9, textBox10 );
		}
		...
		{
			OperateResult<byte[]> read = yamateke.ReadFromCoreServer( HslCommunication.BasicFramework.SoftBasic.HexStringToBytes( textBox13.Text ) );
			if (read.IsSuccess)
			{
