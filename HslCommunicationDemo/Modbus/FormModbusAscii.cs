...
namespace HslCommunicationDemo
{
	public partial class FormModbusAscii : HslFormContent
	{
		...
		private void button1_Click( object sender, EventArgs e )
		{
			...
			try
			{
				...
				if (open.IsSuccess)
				{
					...
					stationSearchControl.SetModbus( busAsciiClient );
		...
		public override void SaveXmlParameter( XElement element )
		{
			...
			element.SetAttributeValue( nameof( ModbusAscii.StationCheckMatch ), checkBox_station_check.Checked );
		...
		public override void LoadXmlParameter( XElement element )
		{
			...
			checkBox_station_check.Checked = GetXmlValue( element, nameof( ModbusAscii.StationCheckMatch ), checkBox_station_check.Checked, bool.Parse );
