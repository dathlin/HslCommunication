namespace HslCommunicationDemo
{
	partial class FormOpenProtocolServer
	{
		...
		private void InitializeComponent( )
		{
			...
			this.userControlHead1.ProtocolInfo = "Open Protocol Server";
			...
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.FormOpenProtocolServer_FormClosing);
