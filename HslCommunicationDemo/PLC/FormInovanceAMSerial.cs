...
namespace HslCommunicationDemo
{
    public partial class FormInovanceAMSerial : HslFormContent
    {
        ...
        {
            OperateResult<byte[]> read = inovanceAMSerial.ReadFromCoreServer( HslCommunication.Serial.SoftCRC16.CRC16( HslCommunication.BasicFramework.SoftBasic.HexStringToBytes( textBox13.Text ) ) );
            if (read.IsSuccess)
            {
