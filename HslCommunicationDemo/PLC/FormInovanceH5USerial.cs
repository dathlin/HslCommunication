...
namespace HslCommunicationDemo
{
    public partial class FormInovanceH5USerial : HslFormContent
    {
        ...
        {
            OperateResult<byte[]> read = inovanceH5USerial.ReadFromCoreServer( HslCommunication.Serial.SoftCRC16.CRC16( HslCommunication.BasicFramework.SoftBasic.HexStringToBytes( textBox13.Text ) ) );
            if (read.IsSuccess)
            {
