    ...
    public partial class FormKeyenceAscii : HslFormContent
    {
        ...
        private void button_read_bool_Click( object sender, EventArgs e )
        {
            ...
            if(textBox12.Text == "1")
                ...
                DemoUtils.ReadResultRender( keyence_net.ReadBool( textBox3.Text, ushort.Parse( textBox12.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_short_Click( object sender, EventArgs e )
        {
            ...
            if (textBox12.Text == "1")
                ...
                DemoUtils.ReadResultRender( keyence_net.ReadInt16( textBox3.Text, ushort.Parse( textBox12.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_ushort_Click( object sender, EventArgs e )
        {
            ...
            if (textBox12.Text == "1")
                ...
                DemoUtils.ReadResultRender( keyence_net.ReadUInt16( textBox3.Text, ushort.Parse( textBox12.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_int_Click( object sender, EventArgs e )
        {
            ...
            if (textBox12.Text == "1")
                ...
                DemoUtils.ReadResultRender( keyence_net.ReadInt32( textBox3.Text, ushort.Parse( textBox12.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_long_Click( object sender, EventArgs e )
        {
            ...
            if (textBox12.Text == "1")
                ...
                DemoUtils.ReadResultRender( keyence_net.ReadInt64( textBox3.Text, ushort.Parse( textBox12.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_ulong_Click( object sender, EventArgs e )
        {
            ...
            if (textBox12.Text == "1")
                ...
                DemoUtils.ReadResultRender( keyence_net.ReadUInt64( textBox3.Text, ushort.Parse( textBox12.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_float_Click( object sender, EventArgs e )
        {
            ...
            if (textBox12.Text == "1")
                ...
                DemoUtils.ReadResultRender( keyence_net.ReadFloat( textBox3.Text, ushort.Parse( textBox12.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_double_Click( object sender, EventArgs e )
        {
            ...
            if (textBox12.Text == "1")
                ...
                DemoUtils.ReadResultRender( keyence_net.ReadDouble( textBox3.Text, ushort.Parse( textBox12.Text ) ), textBox3.Text, textBox4 );
        }
