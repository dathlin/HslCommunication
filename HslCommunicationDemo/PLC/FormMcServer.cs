    ...
    public partial class FormMcServer : HslFormContent
    {
        ...
        private void button_read_bool_Click( object sender, EventArgs e )
        {
            ...
            if(textBox6.Text == "1")
                ...
                readResultRender( mcNetServer.ReadBool( textBox3.Text, ushort.Parse( textBox6.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_short_Click( object sender, EventArgs e )
        {
            ...
            if (textBox6.Text == "1")
                ...
                readResultRender( mcNetServer.ReadInt16( textBox3.Text, ushort.Parse( textBox6.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_ushort_Click( object sender, EventArgs e )
        {
            ...
            if (textBox6.Text == "1")
                ...
                readResultRender( mcNetServer.ReadUInt16( textBox3.Text, ushort.Parse( textBox6.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_int_Click( object sender, EventArgs e )
        {
            ...
            if (textBox6.Text == "1")
                ...
                readResultRender( mcNetServer.ReadInt32( textBox3.Text, ushort.Parse( textBox6.Text ) ), textBox3.Text, textBox4 );
        }
        private void button_read_uint_Click( object sender, EventArgs e )
        {
            ...
            if (textBox6.Text == "1")
                ...
                readResultRender( mcNetServer.ReadUInt32( textBox3.Text, ushort.Parse( textBox6.Text ) ), textBox3.Text, textBox4 );
        }
        private void button_read_long_Click( object sender, EventArgs e )
        {
            ...
            if (textBox6.Text == "1")
                ...
                readResultRender( mcNetServer.ReadInt64( textBox3.Text, ushort.Parse( textBox6.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_ulong_Click( object sender, EventArgs e )
        {
            ...
            if (textBox6.Text == "1")
                ...
                readResultRender( mcNetServer.ReadUInt64( textBox3.Text, ushort.Parse( textBox6.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_float_Click( object sender, EventArgs e )
        {
            ...
            if (textBox6.Text == "1")
                ...
                readResultRender( mcNetServer.ReadFloat( textBox3.Text, ushort.Parse( textBox6.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_double_Click( object sender, EventArgs e )
        {
            ...
            if (textBox6.Text == "1")
                ...
                readResultRender( mcNetServer.ReadDouble( textBox3.Text, ushort.Parse( textBox6.Text ) ), textBox3.Text, textBox4 );
        }
