    ...
    public partial class FormOmron : HslFormContent
    {
        ...
        private void button_read_short_Click( object sender, EventArgs e )
        {
            ...
            if (textBox12.Text == "1")
                ...
                DemoUtils.ReadResultRender( omronFinsNet.ReadInt16( textBox3.Text, ushort.Parse( textBox12.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_ushort_Click( object sender, EventArgs e )
        {
            ...
            if (textBox12.Text == "1")
                ...
                DemoUtils.ReadResultRender( omronFinsNet.ReadUInt16( textBox3.Text, ushort.Parse( textBox12.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_int_Click( object sender, EventArgs e )
        {
            ...
            if (textBox12.Text == "1")
                ...
                DemoUtils.ReadResultRender( omronFinsNet.ReadInt32( textBox3.Text, ushort.Parse( textBox12.Text ) ), textBox3.Text, textBox4 );
        }
        private void button_read_uint_Click( object sender, EventArgs e )
        {
            ...
            if (textBox12.Text == "1")
                ...
                DemoUtils.ReadResultRender( omronFinsNet.ReadUInt32( textBox3.Text, ushort.Parse( textBox12.Text ) ), textBox3.Text, textBox4 );
        }
        private void button_read_long_Click( object sender, EventArgs e )
        {
            ...
            if (textBox12.Text == "1")
                ...
                DemoUtils.ReadResultRender( omronFinsNet.ReadInt64( textBox3.Text, ushort.Parse( textBox12.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_ulong_Click( object sender, EventArgs e )
        {
            ...
            if (textBox12.Text == "1")
                ...
                DemoUtils.ReadResultRender( omronFinsNet.ReadUInt64( textBox3.Text, ushort.Parse( textBox12.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_double_Click( object sender, EventArgs e )
        {
            ...
            if (textBox12.Text == "1")
                ...
                DemoUtils.ReadResultRender( omronFinsNet.ReadDouble( textBox3.Text, ushort.Parse( textBox12.Text ) ), textBox3.Text, textBox4 );
        }
