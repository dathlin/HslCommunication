...
namespace HslCommunicationDemo
{
    public partial class FormOmronServer : HslFormContent
    {
        ...
        {
            label15.Text = omronFinsServer.OnlineCount.ToString( ) ;
        }
        ...
        private void button_read_bool_Click( object sender, EventArgs e )
        {
            // 读取bool变量
            if(textBox6.Text == "1")
                readResultRender( omronFinsServer.ReadBool( textBox3.Text  ), textBox3.Text, textBox4 );
            else
                readResultRender( omronFinsServer.ReadBool( textBox3.Text, ushort.Parse( textBox6.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_short_Click( object sender, EventArgs e )
        {
            // 读取short变量
            if (textBox6.Text == "1")
                readResultRender( omronFinsServer.ReadInt16( textBox3.Text ), textBox3.Text, textBox4 );
            else
                readResultRender( omronFinsServer.ReadInt16( textBox3.Text, ushort.Parse( textBox6.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_ushort_Click( object sender, EventArgs e )
        {
            // 读取ushort变量
            if (textBox6.Text == "1")
                readResultRender( omronFinsServer.ReadUInt16( textBox3.Text ), textBox3.Text, textBox4 );
            else
                readResultRender( omronFinsServer.ReadUInt16( textBox3.Text, ushort.Parse( textBox6.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_int_Click( object sender, EventArgs e )
        {
            // 读取int变量
            if (textBox6.Text == "1")
                readResultRender( omronFinsServer.ReadInt32( textBox3.Text ), textBox3.Text, textBox4 );
            else
                readResultRender( omronFinsServer.ReadInt32( textBox3.Text, ushort.Parse( textBox6.Text ) ), textBox3.Text, textBox4 );
        }
        private void button_read_uint_Click( object sender, EventArgs e )
        {
            // 读取uint变量
            if (textBox6.Text == "1")
                readResultRender( omronFinsServer.ReadUInt32( textBox3.Text ), textBox3.Text, textBox4 );
            else
                readResultRender( omronFinsServer.ReadUInt32( textBox3.Text, ushort.Parse( textBox6.Text ) ), textBox3.Text, textBox4 );
        }
        private void button_read_long_Click( object sender, EventArgs e )
        {
            // 读取long变量
            if (textBox6.Text == "1")
                readResultRender( omronFinsServer.ReadInt64( textBox3.Text ), textBox3.Text, textBox4 );
            else
                readResultRender( omronFinsServer.ReadInt64( textBox3.Text, ushort.Parse( textBox6.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_ulong_Click( object sender, EventArgs e )
        {
            // 读取ulong变量
            if (textBox6.Text == "1")
                readResultRender( omronFinsServer.ReadUInt64( textBox3.Text ), textBox3.Text, textBox4 );
            else
                readResultRender( omronFinsServer.ReadUInt64( textBox3.Text, ushort.Parse( textBox6.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_float_Click( object sender, EventArgs e )
        {
            // 读取float变量
            if (textBox6.Text == "1")
                readResultRender( omronFinsServer.ReadFloat( textBox3.Text ), textBox3.Text, textBox4 );
            else
                readResultRender( omronFinsServer.ReadFloat( textBox3.Text, ushort.Parse( textBox6.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_double_Click( object sender, EventArgs e )
        {
            // 读取double变量
            if (textBox6.Text == "1")
                readResultRender( omronFinsServer.ReadDouble( textBox3.Text ), textBox3.Text, textBox4 );
            else
                readResultRender( omronFinsServer.ReadDouble( textBox3.Text, ushort.Parse( textBox6.Text ) ), textBox3.Text, textBox4 );
        }

        private void button_read_string_Click( object sender, EventArgs e )
        {
            // 读取字符串
            readResultRender( omronFinsServer.ReadString( textBox3.Text, ushort.Parse( textBox5.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button24_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                omronFinsServer.Write( textBox8.Text, bool.Parse( textBox7.Text ) );
        ...
        private void button22_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                omronFinsServer.Write( textBox8.Text, short.Parse( textBox7.Text ) );
                writeResultRender( textBox8.Text );
            }
            catch (Exception ex)
            {
        ...
        private void button21_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                omronFinsServer.Write(textBox8.Text, ushort.Parse( textBox7.Text ) );
                writeResultRender( textBox8.Text );
            }
            catch (Exception ex)
            {
        ...
        private void button20_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                omronFinsServer.Write( textBox8.Text, int.Parse( textBox7.Text ) );
                writeResultRender( textBox8.Text );
            }
            catch (Exception ex)
            {
        ...
        private void button19_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                omronFinsServer.Write( textBox8.Text , uint.Parse( textBox7.Text ) );
                writeResultRender( textBox8.Text );
            }
            catch (Exception ex)
            {
        ...
        private void button18_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                omronFinsServer.Write( textBox8.Text, long.Parse( textBox7.Text ) );
                writeResultRender( textBox8.Text );
            }
            catch (Exception ex)
            {
        ...
        private void button17_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                omronFinsServer.Write(textBox8.Text , ulong.Parse( textBox7.Text ) );
                writeResultRender( textBox8.Text );
            }
            catch (Exception ex)
            {
        ...
        private void button16_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                omronFinsServer.Write( textBox8.Text, float.Parse( textBox7.Text ) );
                writeResultRender( textBox8.Text );
            }
            catch (Exception ex)
            {
        ...
        private void button15_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                omronFinsServer.Write( textBox8.Text, double.Parse( textBox7.Text ) );
                writeResultRender( textBox8.Text );
            }
            catch (Exception ex)
            {
        ...
        private void button14_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                omronFinsServer.Write( textBox8.Text, textBox7.Text );
                writeResultRender( textBox8.Text );
            }
            catch (Exception ex)
            {
        ...
        private void button4_Click( object sender, EventArgs e )
        {
            ...
            using (FormInputAlien form = new FormInputAlien( ))
            {
                ...
                {
                    OperateResult connect = omronFinsServer.ConnectHslAlientClient( form.IpAddress, form.Port, form.DTU );
        ...
        private void button9_Click( object sender, EventArgs e )
        {
            ...
            {
                omronFinsServer.SaveDataPool( "123.txt" );
        ...
        private void button8_Click( object sender, EventArgs e )
        {
            ...
            if (omronFinsServer != null)
            {
                ...
                {
                    omronFinsServer.LoadDataPool( "123.txt" );
        ...
        private void TimerWrite_Tick( object sender, EventArgs e )
        {
            ...
            omronFinsServer.Write( timerAddress, value );
            timerValue++;
        }
