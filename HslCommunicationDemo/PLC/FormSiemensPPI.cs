    ...
    public partial class FormSiemensPPI : HslFormContent
    {
        ...
        private void button_read_bool_Click( object sender, EventArgs e )
        {
            ...
            if(textBox1.Text == "1")
                ...
                DemoUtils.ReadResultRender( siemensPPI.ReadBool( textBox3.Text, ushort.Parse( textBox1.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_short_Click( object sender, EventArgs e )
        {
            ...
            if (textBox1.Text == "1")
                ...
                DemoUtils.ReadResultRender( siemensPPI.ReadInt16( textBox3.Text, ushort.Parse( textBox1.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_ushort_Click( object sender, EventArgs e )
        {
            ...
            if (textBox1.Text == "1")
                ...
                DemoUtils.ReadResultRender( siemensPPI.ReadUInt16( textBox3.Text, ushort.Parse( textBox1.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_int_Click( object sender, EventArgs e )
        {
            ...
            if (textBox1.Text == "1")
                ...
                DemoUtils.ReadResultRender( siemensPPI.ReadInt32( textBox3.Text, ushort.Parse( textBox1.Text ) ), textBox3.Text, textBox4 );
        }
        private void button_read_uint_Click( object sender, EventArgs e )
        {
            ...
            if (textBox1.Text == "1")
                ...
                DemoUtils.ReadResultRender( siemensPPI.ReadUInt32( textBox3.Text, ushort.Parse( textBox1.Text ) ), textBox3.Text, textBox4 );
        }
        private void button_read_long_Click( object sender, EventArgs e )
        {
            ...
            if (textBox1.Text == "1")
                ...
                DemoUtils.ReadResultRender( siemensPPI.ReadInt64( textBox3.Text, ushort.Parse( textBox1.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_ulong_Click( object sender, EventArgs e )
        {
            ...
            if (textBox1.Text == "1")
                ...
                DemoUtils.ReadResultRender( siemensPPI.ReadUInt64( textBox3.Text, ushort.Parse( textBox1.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_float_Click( object sender, EventArgs e )
        {
            ...
            if (textBox1.Text == "1")
                ...
                DemoUtils.ReadResultRender( siemensPPI.ReadFloat( textBox3.Text, ushort.Parse( textBox1.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button_read_double_Click( object sender, EventArgs e )
        {
            ...
            if (textBox1.Text == "1")
                ...
                DemoUtils.ReadResultRender( siemensPPI.ReadDouble( textBox3.Text, ushort.Parse( textBox1.Text ) ), textBox3.Text, textBox4 );
        }
