...
namespace HslCommunicationDemo
{
    public partial class FormXinJEXCSerial : HslFormContent
    {
        ...
        private XinJEXCSerial xinje = null;
        ...
        private void button1_Click( object sender, EventArgs e )
        {
            ...
            xinje?.Close( );
            xinje = new XinJEXCSerial( station );
        ...
        {
            OperateResult<byte[]> read = xinje.ReadBase( HslCommunication.Serial.SoftCRC16.CRC16( HslCommunication.BasicFramework.SoftBasic.HexStringToBytes( textBox13.Text ) ) );
            if (read.IsSuccess)
            {
