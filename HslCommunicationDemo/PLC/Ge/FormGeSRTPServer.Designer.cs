...
{
    partial class FormGeSRTPServer
	{
        /// <summary>
        ...
        private void InitializeComponent( )
        {
			...
			this.label11.Text = "本服务器不是严格的GE SRTP协议，仅支持和HSL组件完美通信。";
			// 
			// button11
			// 
			...
			this.Name = "FormGeSRTPServer";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "GE SRTP虚拟服务器【数据支持I,Q,M,T,SA,SB,SC,S,G,AI,AQ,R】";
