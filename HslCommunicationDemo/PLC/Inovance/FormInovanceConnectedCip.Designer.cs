...
{
    partial class FormInovanceConnectedCip
	{
        /// <summary>
        ...
        private void InitializeComponent( )
        {
			...
			this.textBox_toConnection = new System.Windows.Forms.TextBox();
			...
			this.panel1.Controls.Add(this.textBox_ot);
			this.panel1.Controls.Add(this.label2);
			this.panel1.Controls.Add(this.textBox_toConnection);
			...
			// textBox_ot
			// 
			this.textBox_ot.Location = new System.Drawing.Point(402, 35);
			this.textBox_ot.Name = "textBox_ot";
			this.textBox_ot.Size = new System.Drawing.Size(132, 23);
			this.textBox_ot.TabIndex = 10;
			this.textBox_ot.Text = "0";
			// 
			// label2
			// 
			...
			this.label2.Text = "O->TConnectionId:";
			// 
			// textBox_toConnection
			// 
			this.textBox_toConnection.Location = new System.Drawing.Point(132, 35);
			this.textBox_toConnection.Name = "textBox_toConnection";
			this.textBox_toConnection.Size = new System.Drawing.Size(132, 23);
			this.textBox_toConnection.TabIndex = 8;
			this.textBox_toConnection.Text = "0";
			// 
			// label1
			// 
			...
			this.label1.Text = "T->OConnectionId:";
			// 
			// pipeSelectControl1
			// 
			...
			this.Name = "FormInovanceConnectedCip";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Inovance访问Demo";
		...
		private System.Windows.Forms.TextBox textBox_toConnection;
