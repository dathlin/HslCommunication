...
{
	partial class FormInovanceLinks
	{
		/// <summary>
		...
		private void InitializeComponent( )
		{
			...
			this.label4.Text = "(Server 使用三菱FxLinksServer)";
			// 
			// label3
			// 
			...
			this.label1.Text = "(Set D8126=06h  D8120.14=1   StationNumber: D8121)";
			// 
			// pipeSelectControl1
			// 
            ...
            "1",
            "4"});
			this.comboBox_format.Location = new System.Drawing.Point(407, 35);
			...
			// textBox18
			// 
			this.textBox18.Location = new System.Drawing.Point(169, 36);
			...
			this.userControlHead1.ProtocolInfo = "计算机链接协议";
			...
			this.Name = "FormInovanceLinks";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "汇川PLC访问Demo";
