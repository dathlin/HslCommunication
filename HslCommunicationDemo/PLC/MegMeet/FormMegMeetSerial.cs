    ...
    public partial class FormMegMeetSerial : HslFormContent
    {
        ...
        private void button1_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                ...
                userControlReadWriteOp1.SetReadWriteNet( megMeet, "M100", false );
            }
            catch (Exception ex)
            {
        ...
        {
            OperateResult<byte[]> read = megMeet.ReadFromCoreServer( HslCommunication.Serial.SoftCRC16.CRC16( HslCommunication.BasicFramework.SoftBasic.HexStringToBytes( textBox13.Text ) ) );
            if (read.IsSuccess)
            {
