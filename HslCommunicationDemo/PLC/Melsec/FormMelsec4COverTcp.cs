...
{
	public partial class FormMelsec4COverTcp : HslFormContent
	{
		public FormMelsec4COverTcp( )
		{
			InitializeComponent( );
		...
		private MelsecA4CNetOverTcp melsecA4C = null;
		...
		{
			melsecA4C?.ConnectClose( );
			melsecA4C = new MelsecA4CNetOverTcp( );
			...
			try
			{
				...
				melsecA4C.SumCheck = checkBox_sumcheck.Checked;
				melsecA4C.Format = int.Parse( comboBox_format.SelectedItem.ToString( ) );
				OperateResult connect = DeviceConnectPLC( melsecA4C );
