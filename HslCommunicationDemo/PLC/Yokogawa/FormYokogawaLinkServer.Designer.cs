...
{
    partial class FormYokogawaLinkServer
    {
        /// <summary>
        ...
        private void InitializeComponent( )
        {
			...
			this.label11.Size = new System.Drawing.Size(645, 32);
			this.label11.TabIndex = 29;
			this.label11.Text = "本服务器不是严格的YokogawaLink协议，仅支持和HSL组件完美通信。";
			// 
			// button11
			// 
			this.button11.Enabled = false;
			this.button11.Location = new System.Drawing.Point(220, 2);
			...
			this.userControlHead1.ProtocolInfo = "YokogawaLink";
			...
			this.sslServerControl1.Location = new System.Drawing.Point(6, 31);
			this.sslServerControl1.Name = "sslServerControl1";
			this.sslServerControl1.Size = new System.Drawing.Size(980, 30);
			this.sslServerControl1.TabIndex = 30;
			// 
			// FormYokogawaLinkServer
			// 
			...
			this.Name = "FormYokogawaLinkServer";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "YokogawaLink虚拟服务器【数据支持X,Y,I,E,M,L,D,B,F,R,V,Z,W】";
