namespace HslCommunicationDemo
{
    partial class FormkossiCip
	{
        ...
        private void InitializeComponent( )
        {
			...
			this.checkBox1.Text = "ContextId Auto Increment";
			...
			this.pipeSelectControl1.TabIndex = 10;
			this.pipeSelectControl1.TcpPortText = "44818";
			this.pipeSelectControl1.UdpPortText = "44818";
			// 
			// textBox15
			// 
			this.textBox15.Location = new System.Drawing.Point(51, 37);
			...
			this.panel2.Size = new System.Drawing.Size(996, 535);
			...
			this.userControlReadWriteDevice1.Size = new System.Drawing.Size(994, 533);
			...
			this.userControlHead1.HelpLink = "https://www.kossi.cn/";
			...
			this.label1.Text = "(这个不是默认值，需要手动设置为false，具体看连接成功后的代码示例)";
			// 
			// FormkossiCip
			// 
			...
			this.Name = "FormkossiCip";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Kossi访问Demo";
