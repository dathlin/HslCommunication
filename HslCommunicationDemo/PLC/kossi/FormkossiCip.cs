...
namespace HslCommunicationDemo
{
	public partial class FormkossiCip : HslFormContent
	{
		...
		private void button1_Click( object sender, EventArgs e )
		{
			...
			omronCipNet.ContextIdAutoIncrement = checkBox1.Checked;
			...
			try
			{
				...
				if (connect.IsSuccess)
				{
					...
					codeExampleControl.SetCodeText( omronCipNet, nameof( omronCipNet.Slot ), nameof( omronCipNet.ContextIdAutoIncrement ) );
				}
				else
				{
