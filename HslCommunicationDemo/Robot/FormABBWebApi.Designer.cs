namespace HslCommunicationDemo.Robot
{
    partial class FormABBWebApi
    {
        ...
        private void InitializeComponent( )
        {
			...
			this.label14.Text = "Set url example:  url=/rw/rapid/symbol/data/RAPID/T_ROB1/user/reg1?action=set";
			// 
			// button_io_signal
			// 
			...
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.FormABBWebApi_FormClosing);
